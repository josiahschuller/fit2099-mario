...
public class DropSuperMushroomAction extends DropItemAction {
     ...
     */
    public DropSuperMushroomAction(Item item) {
        super(item);
        this.item = item;
    }
    ...
    public String execute(Actor actor, GameMap map) {
        ...
        actor.removeCapability(Status.TALL); // Remove tall capability
        actor.removeCapability(Status.JUMP_FREELY); // Remove capability to jump freely

        return actor + " loses the Super Mushroom and its effects";
    }
    ...
    public String menuDescription(Actor actor) {
        return actor + " drops Super Mushroom";
    }
}
